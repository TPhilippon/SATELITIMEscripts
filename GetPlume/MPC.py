...
#    
   # xpixels,ypixels = im.size[1],im.size[0]
    ...
    xinch = int(zr.shape[1]) * scalefactor / dpi
    yinch = int(zr.shape[0]) * scalefactor / dpi
#    
...
def data_type():
    outpath = 'MAMBA/' #'Y:/SATELITIME/data/MAMBA/'
    inpath = 'ZR/' #'Y:/SATELITIME/data/ZR/'
...
if __name__ == '__main__':
    ...
    f1=np.load(data[0]) #(os.path.join(inpath,data[0]))
